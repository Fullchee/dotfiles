...
ensure_brew duti                        # set default applications
...
ensure_brew orchardworks/tap/orchard-ops
ensure_brew raycast
ensure_brew rectangle
ensure_brew thaw
ensure_brew wispr-flow

ensure_mas_app 1440147259 # ad guard for Safari
...
ensure_mas_app 1521432881 # Session Pomodoro Focus Timer
